...
Creating a data set with no income variable (to test economic hypothesis separately with fewer countries). 
```{r}
...
pred_plots1 <- plot_model(m_with, type = "pred")
pred_plots1 <- lapply(pred_plots1, function(p) {
  p + theme(axis.text.x = element_text(angle = 45, hjust = 1))
})
combined_plot1 <- wrap_plots(pred_plots1)
#ggsave("combined_plot1.png", plot = combined_plot1, width = 14, height = 20, dpi = 300)
```
